          ...
          absolute md:grid grid-cols-12 w-full h-full  content-center "
            >
              <div className="relative rounded w-full h-full col-span-7 ">
                <a href="https://github.com/KunalKatiyar/pepega" target={"_blank"} rel="noreferrer">
                  <div
           ...
           transition-opacity opacity-60 hover:opacity-0 hover:cursor-pointer duration-300"
                ...
                <Img src={"/pepega.png"} alt={"Project Screen shot"} className={`w-full rounded h-full `} />
              </div>
            </div>
            ...
            <div className=" md:absolute py-4  md:grid md:grid-cols-12 w-full h-full  content-center ">
              ...
              <div className="absolute w-full h-full bg-opacity-70 z-0">
                <div className="relative w-full h-full">
                  ...
                  <Img src={"/pepega.png"} alt={"Project Screen shot"} className={`w-full h-full`} />
                </div>
              </div>
              ...
              >
                ...
                <div className="w-full md:bg-AAtertiary rounded-md py-6 md:p-6  z-10">
                  <p className="text-gray-300 md:text-gray-400 text-left md:text-right">
                    An <span className="text-AAsecondary">interpreter</span> written in <span className="text-AAsecondary">Rust</span> which
                    interpetes a new language that uses Twitch emotes as its keywords.
                  </p>
                </div>
                <ul
               ...
               text-sm font-Text2 md:justify-end"
                >
                  ...
                  <span className="pr-4 z-10">Compilers and Interpreters</span>
                  <span className="pr-4 z-10">Environments</span>
                </ul>
                <div className="z-10 flex fle-row space-x-5 sm:pt-0 pt-2">
                  <GithubIcon link="https://github.com/KunalKatiyar/pepega" />
                </div>
              </div>
            </div>
          </div>
