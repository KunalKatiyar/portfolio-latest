...
export default function AboutMe(props) {
  const technologies = [
    ["JavaScript", "Rust","Google Cloud Services","Python", "Tailwind CSS", "Flutter", "Godot"],
    ["Vue", "Node.js","React.js", "MongoDB", "Docker", "C++", "Java"],
  ];
  return (
        ...
        <div className="w-full flex flex-col md:flex-row space-y-8 md:space-y-0 md:space-x-8 sm:space-x-2 ">
          <div className="w-full md:w-7/12 space-y-4 sm:text-base text-sm ">
            <div className="font-Header ">
              <span className="text-gray-400  tracking-wide">
                Hello! My name is Kunal and I enjoy solving problems and creating codes that live on the internet.
                My interest in computer science started back in 2018 when I decided to try learning{" "}
                <span className="text-AAsecondary">Node.js</span> — which kicktarted my journey with programming started
                from that time!
              </span>
            </div>
            <div className="font-Header tracking-wide">
              <span className="text-gray-400  ">
                ...
                <span className="text-AAsecondary"> a huge real-estate tech company</span>,
                <span className="text-AAsecondary"> a ML-based start-up</span>,{" "}
          ...
          <div className="group relative lg:w-96 lg:h-96 md:w-72 md:h-72 md:block hidden ">
            ...
            <div className="absolute w-5/6 h-5/6  rounded overflow-hidden">
              <div className="absolute w-full h-full group-hover:opacity-0 bg-AAprimary opacity-20 duration-300 rounded overflow-hidden"></div>
